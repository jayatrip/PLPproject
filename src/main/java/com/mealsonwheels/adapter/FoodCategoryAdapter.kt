...
class FoodCategoryAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var items: List<Restaurants> = ArrayList()
    ...
    fun submitList(categoryList: List<Restaurants>) {
        items = categoryList
    }
    ...
    interface CategoryClickListener{
        fun  onCategoryClicked(view: View, category: Restaurants)
    }
